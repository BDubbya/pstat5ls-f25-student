...
To avoid your work being overwritten, **rename** this file (`hw1.Rmd`). You could add your name to the file name (e.g., `hw1-brianw.Rmd`).
...
![Click the "Knit" button at the top of the editor pane"](assets/images/hw1-knit-button.png){scale="75%"}
...
![Click Download to save the file](assets/images/hw1_html_download.png){scale="50%"}
