...
sim2 <- simulate_chance_model(chanceSuccess =  , 
                              numDraws =  , 
                              numRepetitions =  )
...
![Click the "Knit" button at the top of the editor pane"](assets/images/hw1-knit-button.png){scale="50%"}
...
Now upload the HTML as your answer to Question 2.4 of HW 3 in Gradescope.
